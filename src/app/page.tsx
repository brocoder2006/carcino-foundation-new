...
export default function CarcinoFoundationLandingPage() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute top-[10%] left-[20%] w-[500px] h-[500px] rounded-full blur-[140px] pointer-events-none transition-all duration-500 ${isLightMode ? "bg-[#C27AFF]/30" : "bg-[#C27AFF]/15"
          }`}
      ></div>
      <div
        className={`absolute top-[35%] right-[15%] w-[450px] h-[450px] rounded-full blur-[140px] pointer-events-none transition-all duration-500 ${isLightMode ? "bg-[#FF7A00]/20" : "bg-[#FF5500]/15"
          }`}
      ></div>
      ...
      <img
        ...
        className={`absolute top-0 left-0 w-full h-screen object-cover pointer-events-none transition-all duration-700 blur-sm scale-102 ${isLightMode ? "opacity-90 brightness-105 contrast-105" : "opacity-75"
          }`}
      ...
      <header
        ref={navRef}
        className="sticky top-0 z-50 flex pt-4 md:pt-6 pb-2 px-4 md:px-[84px] justify-center items-center w-full max-w-7xl mx-auto transition-all duration-300"
      >
        {/* Mobile View Top Bar (Logo + Theme Toggle + Mobile Menu Trigger) */}
        <div className="flex items-center justify-between w-full md:hidden px-4 py-2.5 rounded-full glass-navbar border border-white/20">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="w-9 h-9 rounded-full flex items-center justify-center bg-white/10 hover:bg-white/20 transition-all cursor-pointer"
            >
              {isLightMode ? (
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#171717" strokeWidth="2"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>
              ) : (
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#F8F8F8" strokeWidth="2"><circle cx="12" cy="12" r="5"></circle><line x1="12" y1="1" x2="12" y2="3"></line><line x1="12" y1="21" x2="12" y2="23"></line></svg>
              )}
            </button>
            ...
            <button
              ...
              className="px-2.5 h-9 rounded-full flex items-center justify-center bg-white/10 hover:bg-white/20 text-xs font-bold transition-all cursor-pointer gap-1"
            >
              <svg
                width="14"
                height="14"
            ...
            >
              {isMobileMenuOpen ? (
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={isLightMode ? "#171717" : "white"} strokeWidth="2.5"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
              ) : (
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke={isLightMode ? "#171717" : "white"} strokeWidth="2.5"><line x1="4" y1="7" x2="20" y2="7"></line><line x1="4" y1="12" x2="20" y2="12"></line><line x1="4" y1="17" x2="20" y2="17"></line></svg>
              )}
            </button>
          </div>
        </div>
        ...
        <div className="hidden md:flex items-center gap-3 w-fit mx-auto">
          <div className="flex p-2 items-center gap-1 rounded-[999px] glass-navbar w-fit h-16 overflow-x-auto max-w-[calc(100vw-80px)] scrollbar-none">
            <div className="flex flex-col items-start w-fit">
              <div className="flex justify-center items-center gap-1 w-fit">
                ...
                <div className="flex pr-0.5 flex-col items-start w-fit">
                  <button
                    onClick={scrollToTop}
                    className={`cursor-pointer text-nowrap flex py-2.5 px-5 justify-center items-center rounded-[999px] transition-all duration-300 w-fit ${activeNavItem === "Home" ? "glass-btn-primary" : "glass-nav-item"
                      }`}
                  >
                    <p
                      className={`font-inter text-base w-fit ${activeNavItem === "Home"
                ...
                <div className="flex pr-0.5 flex-col items-start w-fit">
                  <button
                    ...
                    className={`cursor-pointer text-nowrap flex py-2.5 px-5 justify-center items-center rounded-[999px] transition-all duration-300 w-fit ${activeNavItem === "About" ? "glass-btn-primary" : "glass-nav-item"
                      }`}
                  >
                    <p
                      className={`font-inter text-base w-fit ${activeNavItem === "About"
                        ? "text-[#0C2822] font-bold"
                        : `font-medium ${isLightMode ? "text-[#171717]" : "text-[#F8F8F8]"}`
                        }`}
                    >
                ...
                <div className="flex pr-0.5 flex-col items-start w-fit">
                  <button
                    ...
                    className={`cursor-pointer text-nowrap flex py-2.5 px-5 justify-center items-center rounded-[999px] transition-all duration-300 w-fit ${activeNavItem === "Articles" ? "glass-btn-primary" : "glass-nav-item"
                      }`}
                  >
                    <p
                      className={`font-inter text-base w-fit ${activeNavItem === "Articles"
                        ? "text-[#0C2822] font-bold"
                        : `font-medium ${isLightMode ? "text-[#171717]" : "text-[#F8F8F8]"}`
                        }`}
                    >
                ...
                <div className="flex pr-0.5 flex-col items-start w-fit">
                  <button
                    ...
                    className={`cursor-pointer text-nowrap flex py-2.5 px-5 justify-center items-center rounded-[999px] transition-all duration-300 w-fit ${activeNavItem === "Features" ? "glass-btn-primary" : "glass-nav-item"
                      }`}
                  >
                    <p
                      className={`font-inter text-base w-fit ${activeNavItem === "Features"
                        ? "text-[#0C2822] font-bold"
                        : `font-medium ${isLightMode ? "text-[#171717]" : "text-[#F8F8F8]"}`
                        }`}
                    >
                ...
                <div className="flex pr-0.5 flex-col items-start w-fit">
                  <button
                    ...
                    className={`cursor-pointer text-nowrap flex py-2.5 px-5 justify-center items-center rounded-[999px] transition-all duration-300 w-fit ${activeNavItem === "Podcasts" ? "glass-btn-primary" : "glass-nav-item"
                      }`}
                  >
                    <p
                      className={`font-inter text-base w-fit ${activeNavItem === "Podcasts"
                        ? "text-[#0C2822] font-bold"
                        : `font-medium ${isLightMode ? "text-[#171717]" : "text-[#F8F8F8]"}`
                        }`}
                    >
                ...
                <div className="flex pr-1 flex-col items-start w-fit">
                  <button
                    onClick={() => setActiveNavItem("Survivors")}
                    className={`cursor-pointer text-nowrap flex py-2.5 px-5 justify-center items-center rounded-[999px] transition-all duration-300 w-fit ${activeNavItem === "Survivors" ? "glass-btn-primary" : "glass-nav-item"
                      }`}
                  >
                    <p
                      className={`font-inter text-base w-fit ${activeNavItem === "Survivors"
                        ? "text-[#0C2822] font-bold"
                        : `font-medium ${isLightMode ? "text-[#171717]" : "text-[#F8F8F8]"}`
                        }`}
                    >
          ...
          {/* Desktop Language Toggle Button (Just beside theme toggle) */}
          <button
            onClick={toggleLang}
            aria-label="Change language"
            title="Change language"
            className="flex items-center justify-center px-4 h-12 rounded-full glass-navbar cursor-pointer hover:scale-105 active:scale-95 transition-all duration-300 font-inter text-xs font-bold gap-1.5 shrink-0"
          >
            <svg
              width="16"
              height="16"
      ...
      {isMobileMenuOpen && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={scrollToArticles}
              className={`py-3 px-5 rounded-2xl text-left transition-all duration-300 cursor-pointer ${activeNavItem === "Articles"
                ? "glass-btn-primary font-bold text-[#0C2822]"
                : "glass-nav-item font-medium"
                }`}
            >
            ...
            <button
              onClick={scrollToPodcasts}
              className={`py-3 px-5 rounded-2xl text-left transition-all duration-300 cursor-pointer ${activeNavItem === "Podcasts"
                ? "glass-btn-primary font-bold text-[#0C2822]"
                : "glass-nav-item font-medium"
                }`}
            >
            ...
            <button
              ...
              className={`py-3 px-5 rounded-2xl text-left transition-all duration-300 cursor-pointer ${activeNavItem === "Survivors"
                ? "glass-btn-primary font-bold text-[#0C2822]"
                : "glass-nav-item font-medium"
                }`}
            >
      ...
      <main className="flex pt-12 pr-6 md:pr-[84px] pb-[72px] pl-6 md:pl-[84px] items-center justify-center gap-16 w-full max-w-7xl mx-auto my-8 overflow-hidden z-10 relative">
        <div ref={heroRef} className="flex flex-col items-start gap-7 w-full max-w-[960px] overflow-hidden">
          ...
          <p
            className={`font-robotoMono text-lg md:text-xl leading-[1.55em] w-full transition-colors duration-400 ${isLightMode ? "text-[#18181B]" : "text-[#F8F8F8] opacity-90"
              }`}
          >
            {t("hero_desc")}
          </p>
